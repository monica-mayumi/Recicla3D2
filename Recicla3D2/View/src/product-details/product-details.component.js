...
require("./product-details.component.css");
require("bootstrap");
    ...
    addEvents() {
        ...
        $(".btn-success").click(function () {
            if (localStorage.getItem('username')) {
                ...
                classScope.prodName.push($("#card-title")[0].innerText);
                classScope.prodPreco.push($("#produto-preco")[0].innerText.replace(/[^0-9]+/g, "") * Number($(".form-control")[0].value));
                classScope.quantidade[idProduct] = Number($(".form-control")[0].value);
                classScope.ultimaQuantidadeSelecionada.push(Number($(".form-control")[0].value));
                classScope.productIdDb.push(Number($(".productIdDb")[0].innerText));
                $(".btn-success")[0].style.display = 'none';
                $(".btn-danger")[0].style.display = 'inline';
        ...
        $(".btn-danger").click(function () {
            ...
            classScope.prodName.splice(classScope.prodName.indexOf($("#card-title")[0].innerText), 1);
            classScope.prodPreco.splice(classScope.prodPreco.indexOf($("#produto-preco")[0].innerText.replace(/[^0-9]+/g, "") * Number($(".form-control")[0].value)), 1);
            classScope.quantidade[idProduct] = 1;
            classScope.ultimaQuantidadeSelecionada.splice(classScope.ultimaQuantidadeSelecionada.indexOf(Number($(".form-control")[0].value)), 1);
            classScope.productIdDb.splice(classScope.productIdDb.indexOf(Number($(".productIdDb")[0].innerText)), 1);
            $(".btn-success")[0].style.display = 'inline';
            $(".btn-danger")[0].style.display = 'none';
...
], ProductDetails.prototype, "username", void 0);
